...
public class CrearCuenta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setBackground(new java.awt.Color(255, 107, 26));
        jTextField1.setFont(new java.awt.Font("SansSerif", 0, 18)); // NOI18N
        jTextField1.setForeground(new java.awt.Color(255, 255, 255));
        jTextField1.setText("   Contraseña");
        jTextField1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 107, 26), 8, true));
        jPanel7.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 290, 410, 50));

        jTextField2.setBackground(new java.awt.Color(255, 107, 26));
        jTextField2.setFont(new java.awt.Font("SansSerif", 0, 18)); // NOI18N
        jTextField2.setForeground(new java.awt.Color(255, 255, 255));
        jTextField2.setText("   Usuario o correo");
        jTextField2.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 107, 26), 8, true));
        jPanel7.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 210, 410, 50));

        jTextField3.setBackground(new java.awt.Color(255, 107, 26));
        jTextField3.setFont(new java.awt.Font("SansSerif", 0, 18)); // NOI18N
        jTextField3.setForeground(new java.awt.Color(255, 255, 255));
        jTextField3.setText("   Nombre de Usuario");
        jTextField3.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 107, 26), 8, true));
        jTextField3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField3ActionPerformed(evt);
            }
        });
        jPanel7.add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 130, 410, 50));
    ...
    private void redimensionar() {
        ...
        // Campos de texto
        jTextField3.setBounds(xInput, 130, anchoInput, 50);  // Nombre
        ...
        jTextField2.setBounds(xInput, 210 + bajada, anchoInput, 50);
        jTextField1.setBounds(xInput, 290 + bajada, anchoInput, 50);
